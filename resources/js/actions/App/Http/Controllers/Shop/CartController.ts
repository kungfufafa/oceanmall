...
/**
* @see \App\Http\Controllers\Shop\CartController::index
...
* @see app/Http/Controllers/Shop/CartController.php:73
* @route '/cart/{line}'
*/
...
const CartController = { index, add, update, destroy, clear }
