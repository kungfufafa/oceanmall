    ...
    <Container class="py-4 lg:py-10">
        <div class="grid grid-cols-1 lg:grid-cols-5 lg:gap-x-12">
            <aside class="lg:col-span-1">
                ...
                <nav
                    role="navigation"
                    class="mb-3 flex [scrollbar-width:none] gap-1 overflow-x-auto lg:hidden [&::-webkit-scrollbar]:hidden"
                ...
                <nav
                    v-if="isSettings"
                    role="navigation"
                    class="mb-4 flex [scrollbar-width:none] gap-1 overflow-x-auto lg:hidden [&::-webkit-scrollbar]:hidden"
