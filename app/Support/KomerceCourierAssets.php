...
final class KomerceCourierAssets
{
    ...
    private const LOGOS = [
        ...
        'anteraja' => 'https://storage.googleapis.com/komerce/assets/illustration/anteraja.png',
        'pos' => 'https://storage.googleapis.com/komerce/assets/illustration/POS.png',
        'tiki' => 'https://storage.googleapis.com/komerce/assets/illustration/TIKI.png',
        'lion' => 'https://storage.googleapis.com/komerce/assets/logo/lion-parcel.svg',
        'wahana' => 'https://storage.googleapis.com/komerce/assets/illustration/wahana.png',
